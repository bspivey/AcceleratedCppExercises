...
int main() {
    ...
    if (city == name)
        cout << "The city and name have the same name." << endl;
    else
        cout << "The city and name are different." << endl;

    if (city > name)
        cout << "The city is longer than the name." << endl;
    else
        cout << "The city is not longer than the name." << endl;
